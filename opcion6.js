var preguntas = [
    " ¿Cuál fue el seudónimo utilizado por Hulk durante su etapa como matón de dudosa moralidad?",
    "¿Cómo se llamaba el joven al que el Dr. Banner intentó salvar durante la explosión que desencadenaría su transformación en Hulk?",
    "¿Qué parentesco vincula a Hulk con She-Hulk?",
    " ¿Qué agrupación se encargó de desterrar a Hulk del planeta Tierra, desencadenando la saga Planet Hulk?",
    ];
    ...
    var opciones = [
        ...
        ["Ella es su sobrina",
        "Son primos",
        "Son hermanos por parte de madre",
    ],
        ["The Avengers ",
        " The Illuminate",
        " Nova Corps",
